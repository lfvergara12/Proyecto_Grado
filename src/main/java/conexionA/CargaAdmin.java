...
public class CargaAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String key = "https://bucket-reportes-icfes.s3.us-east-2.amazonaws.com/" + nombreUnico + ".pdf";

            // Supongamos que el nombre del archivo en S3 será el mismo que el nombre original
            String nombrePDF = nombreUnico + ".pdf";
            ...
            if (filasAfectadas > 0) {
                ...
                cargarArchivoEnS3(filePath, nombrePDF);

                // Después de cargar el archivo con éxito
                request.setAttribute("cargaExitosa", "Archivo cargado exitosamente");
            } else {
    ...
    public void cargarArchivoEnS3(String filePath, String key) {
