...
private void sendEmail(String to, String subject, String body) {
    ...
    Session session = Session.getInstance(props, new Authenticator() {
        ...
        protected PasswordAuthentication getPasswordAuthentication() {
            return new PasswordAuthentication("AWIDPRO12@gmail.com", "qadx bkyv uklv fifo");
        }
    });
    ...
    try (Connection connection = DBUtil.getConnection()) {
        ...
        if (userCountResult.next() && userCountResult.getInt(1) > 0) {
            ...
            String body = "Hola " + nombre + ",\n\n"
                    ...
                    + "Usuario: " + usuario + "\n"
                    + "Contraseña: " + password + "\n\n"
                    + "Tu registro se ha completado con éxito. Si en algún momento necesitas ayuda o deseas cambiar tu contraseña, "
                    + "no dudes en contactarnos. Estamos aquí para asistirte en lo que necesites. ¡Bienvenido!";

            sendEmail(to, subject, body);

            // Registro exitoso, redirigir a la página de inicio de sesión
            System.out.println("Atributo registroExitoso configurado con éxito");
            request.setAttribute("registroExitoso", "¡Registro exitoso! Ahora puedes iniciar sesión con tu usuario y contraseña.");
...
public void loginUser(HttpServletRequest request, HttpServletResponse response)
    ...
    private void deleteUser(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DBUtil.getConnection()) {
         ...
         // Después de eliminar el usuario con éxito
            request.setAttribute("eliminacionExitosa", "Usuario eliminado con éxito");
    ...
    private void createUser(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DBUtil.getConnection()) {
            ...
            // Redirigir a la página de lista de usuarios
            request.setAttribute("registroExitoso", "Usuario creado exitosamente");
            request.getRequestDispatcher("users.jsp").forward(request, response);
        } catch (SQLException e) {
            e.printStackTrace();
            // Manejar el error de la base de datos si es necesario
    ...
    private void editUser(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DBUtil.getConnection()) {
            ...
            // Redirigir a la página de lista de usuarios
            request.setAttribute("actualizacionExitosa", "Usuario actualizado exitosamente");
            request.getRequestDispatcher("users.jsp").forward(request, response);
        } catch (SQLException e) {
            e.printStackTrace();
            // Mostrar mensaje de error
