...
<form action="UserController?action=editUser" method="post">
    ...
    <input type="text" name="apellido" value="<%= request.getAttribute("apellido") %>"><br>
    <label for="email">Email:</label>
    <input type="email" name="email" value="<%= request.getAttribute("email") %>"><br>
    <label for="usuario">Usuario:</label>
    <input type="text" name="usuario" value="<%= request.getAttribute("usuario") %>"><br>
